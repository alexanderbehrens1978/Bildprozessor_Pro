...
class ImageProcessorApp:
    ...
    def load_default_settings(self):
        ...
        if os.path.exists(settings_file):
            ...
            messagebox.showwarning("Einstellungen nicht gefunden",
                                   "Die Datei settings.json wurde im Programmordner nicht gefunden.")
    ...
    def set_poppler_path(self):
        ...
        prog_path = os.path.dirname(os.path.abspath(__file__))
        # Verwende einen Rohstring, um die Backslashes korrekt zu interpretieren
        path = filedialog.askdirectory(title=r"Wähle den Ordner Bildprozessor_Pro\_internal\poppler_bin\bin", initialdir=prog_path)
        if path:
    ...
    def get_poppler_path(self):
        # Gibt den eingebundenen Poppler-Pfad zurück, falls die Anwendung gebündelt wurde.
